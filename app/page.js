    ...
    <div style={{ background: '#080808', minHeight: '100vh', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', fontFamily: 'Nunito, sans-serif', padding: '40px 16px' }}>
      <style>{`
        ...
        *, *::before, *::after { margin: 0; padding: 0; box-sizing: border-box; }
        .profile-wrap { width: 100%; max-width: 480px; display: flex; flex-direction: column; align-items: center; }
        ...
        .link-btn { width: 100%; padding: 14px 20px; border-radius: 14px; background: #111; border: 1px solid #1e1e1e; color: #888; font-family: 'Nunito', sans-serif; font-size: 14px; font-weight: 700; text-align: center; text-decoration: none; transition: all 0.2s; display: flex; align-items: center; justify-content: center; position: relative; }
        ...
        .footer { margin-top: 36px; font-size: 12px; color: #252525; font-weight: 700; letter-spacing: 0.5px; }
        .footer a { color: #CC0000; text-decoration: none; opacity: 0.7; }
      ...
      <div className="profile-wrap">
        ...
        <div className="links">
          {links.length === 0 && (
            <div style={{ fontSize: '13px', color: '#222', textAlign: 'center', padding: '8px 0' }}>No links added yet.</div>
          )}
          {links.map((l, i) => (
